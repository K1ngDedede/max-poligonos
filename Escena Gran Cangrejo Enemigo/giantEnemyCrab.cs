...
public class giantEnemyCrab : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        letThereBeCrab(10, 1, 10, 1.5f, -80);
        //caballeros
    ...
    protected void letThereBeCrab(float x, float y, float z, float m, float r)
    {
    ...
    protected GameObject oculi(float x, float y, float z, GameObject f)
    {
    ...
    protected void patas(float x, float y, float z, float r1, float r2, GameObject f, List<GameObject> crabRender)
    {
    ...
    protected void timeForCrab(GameObject crab, List<GameObject> crabRender)
    {
        ...
        l2.transform.parent = crab.transform;
        ...
        l2.transform.localPosition = new Vector3(0.418f, 0.916f, 1);
        ...
        l2.transform.localScale = new Vector3(0.1696f, 0.4611f, 0.239f);
        ...
        l2.transform.localEulerAngles = new Vector3(10.99f, -75.68f, 39.78f);
        crabHammer(0.12f, -1.1f, 0.4f, -4.52f, 102.48f, -78.87f, 0.088f, 1.779f, 0.783f, r2, crabRender);
        crabHammer(-0.2245f, -1.03f, -0.219f, 18.609f, 79.595f, -108.468f, 0.5158f, 3.3817f, 0.7587f, l2, crabRender);
        crabRender.Add(r1);
        crabRender.Add(r2);
        crabRender.Add(l1);
        crabRender.Add(l2);
    ...
    protected void crabHammer(float x, float y, float z, float r1, float r2, float r3, float s1, float s2,
    ...
    protected void knight(float x, float y, float z, float r)
    {
    ...
    protected void yuca(float x, GameObject knig, List<GameObject> steelRender)
    {
    ...
    protected void legpiece(float x, GameObject knig, List<GameObject> steelRender)
    {
    ...
    protected void strBuild(GameObject knig)
    {
    ...
    protected void castelo(float x, float z, float r)
    {
    ...
    protected void castleWalls(GameObject castelo, List<GameObject> stoneRender)
    {
    ...
    protected void theTower(float x, float z, GameObject castelo=null)
    {
        GameObject spire = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
        if (castelo != null)
        {
    ...
    protected void BattlementsT(GameObject spire, int iterator)
    {
        Texture2D texture = (Texture2D) Resources.Load ("Doge texturas/tijolo");
        for (int sapo = 1; sapo <= iterator; sapo++)
        {
    ...
    protected void BattlementsW(GameObject cwall)
    {
        Texture2D texture = (Texture2D) Resources.Load ("Doge texturas/tijolo");
